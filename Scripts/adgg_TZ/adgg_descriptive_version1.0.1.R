#===========================================================================================================================================================
# ADGG Descriptive statistics
# Trait: Test day milk yield
# Author: Isidore Houaga                                  
# Version 1.0.1                                                        
# Date: 22/02/2023                                                    
#===========================================================================================================================================================
#How many records do you have per each level or value of your fixed effects (use table())? 
#How does the milk yield vary per each level or value of your fixed effects (calculate and
#plot mean and standard deviation of milk yield per each level or value
#-----------------------------------------------------------------------------------------------------------------------------------------------------------
rm(list=ls())
...
head(data2)
#toydata<- data2[c(1,21,28, 31, 42, 56, 72, 82, 95, 106),]
